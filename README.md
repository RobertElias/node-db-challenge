...
# Databases are tables and columns storing information that use SQL to query that information, store information, update information.
- [x] Why do tables need a `primary key`?
# The primary key serves as a unique identifier.
